    ...
    <div className="px-6 md:px-12 lg:px-24 pt-16 bg-secondary">
      <div className="max-w-8xl mx-auto">
        <div 
          ...
          style={{
            backgroundImage: `url('/img/SINODE.jpeg')`
          }}
        >
          {/* Overlay */}
          ...
          <div className="relative z-10 ml-16">
            <div className="text-left text-white max-w-3xl">
              {/* Purple badge */}
              <div className="mb-4">
                <Link href="/" className="bg-primary text-white px-4 py-2 rounded-full flex items-center space-x-2 w-fit hover:bg-purple-700 transition-colors">
